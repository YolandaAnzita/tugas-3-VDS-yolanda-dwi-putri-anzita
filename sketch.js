...
function setup() {
  ...
  sun = new Body(50,createVector(0,0),createVector(0,0), true, "#FFFF00")
  ...
  for (let i = 0; i < numPlanets; i++) {
    ...
    planets.push( new Body(mass, planetPos, planetVel, false, '#' + randomColor) )
  }
}
...
function Body(_mass, _pos, _vel, isSun, color){
  this.mass = _mass
  this.pos = _pos
  this.vel = _vel
  this.d = this.mass*2
